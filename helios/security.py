...
ALLOWED_VAR_KEYS = frozenset({
    ...
    # THEOROS canon → theoros-short (DIOSCURI enqueue). Values are Theoros's own prose.
    "chapter", "hook", "body", "debate", "canon_url", "column",
    # Per-repo product visuals (release-short / Calliope).
    "hero", "still",
})
