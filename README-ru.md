...
> **Шаблон на входе → озвученное видео → очередь на YouTube — private by default, пока не approve.**  
...
| | |
|---|---|
| **Роль** | Рендер MP4 из yaml-шаблонов → загрузка на YouTube (private by default) → approve оператором → public |
| **Monitor** | [Alien Monitor](https://monitor.modelmarket.dev/) — клик по **HELIOS** → статистика канала |
