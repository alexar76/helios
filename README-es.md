...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-67%20passed-brightgreen" alt="67 tests passed" />
...
> **Plantilla dentro, vídeo con voz fuera, cola en YouTube — privado por defecto hasta que apruebes.**  
...
| | |
|---|---|
| **Rol** | Render MP4 desde plantillas yaml → subida a YouTube (private by default) → approve del operador → public |
| **Monitor** | [Alien Monitor](https://monitor.modelmarket.dev/) — clic en **HELIOS** → estadísticas del canal |
